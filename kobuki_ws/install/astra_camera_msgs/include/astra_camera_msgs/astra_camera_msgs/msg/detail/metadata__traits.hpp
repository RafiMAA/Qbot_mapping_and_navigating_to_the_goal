...
// IWYU pragma: private, include "astra_camera_msgs/msg/metadata.hpp"
...
inline void to_yaml(
  const astra_camera_msgs::msg::Metadata & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const astra_camera_msgs::msg::Metadata & msg)
{
