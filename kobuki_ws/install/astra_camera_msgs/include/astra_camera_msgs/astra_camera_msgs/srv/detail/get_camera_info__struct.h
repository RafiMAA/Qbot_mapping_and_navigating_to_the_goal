...
enum
{
  astra_camera_msgs__srv__GetCameraInfo_Event__request__MAX_SIZE = 1
};
// response
enum
{
  astra_camera_msgs__srv__GetCameraInfo_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetCameraInfo in the package astra_camera_msgs.
typedef struct astra_camera_msgs__srv__GetCameraInfo_Event
{
  service_msgs__msg__ServiceEventInfo info;
  astra_camera_msgs__srv__GetCameraInfo_Request__Sequence request;
  astra_camera_msgs__srv__GetCameraInfo_Response__Sequence response;
} astra_camera_msgs__srv__GetCameraInfo_Event;

// Struct for a sequence of astra_camera_msgs__srv__GetCameraInfo_Event.
typedef struct astra_camera_msgs__srv__GetCameraInfo_Event__Sequence
{
