...
class Init_GetCameraInfo_Event_response
{
public:
  explicit Init_GetCameraInfo_Event_response(::astra_camera_msgs::srv::GetCameraInfo_Event & msg)
  : msg_(msg)
  {}
  ::astra_camera_msgs::srv::GetCameraInfo_Event response(::astra_camera_msgs::srv::GetCameraInfo_Event::_response_type arg)
  {
...
private:
  ::astra_camera_msgs::srv::GetCameraInfo_Event msg_;
};

class Init_GetCameraInfo_Event_request
{
public:
  explicit Init_GetCameraInfo_Event_request(::astra_camera_msgs::srv::GetCameraInfo_Event & msg)
  : msg_(msg)
  {}
  Init_GetCameraInfo_Event_response request(::astra_camera_msgs::srv::GetCameraInfo_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetCameraInfo_Event_response(msg_);
  }
...
class Init_GetCameraInfo_Event_info
{
public:
  Init_GetCameraInfo_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetCameraInfo_Event_request info(::astra_camera_msgs::srv::GetCameraInfo_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetCameraInfo_Event_request(msg_);
  }
...
template<>
inline
auto build<::astra_camera_msgs::srv::GetCameraInfo_Event>()
{
  return astra_camera_msgs::srv::builder::Init_GetCameraInfo_Event_info();
}
