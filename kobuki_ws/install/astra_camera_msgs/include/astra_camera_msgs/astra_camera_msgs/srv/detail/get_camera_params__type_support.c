...
void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  astra_camera_msgs__srv__GetCameraParams_Event__init(message_memory);
}

void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_fini_function(void * message_memory)
{
  astra_camera_msgs__srv__GetCameraParams_Event__fini(message_memory);
}

size_t astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__size_function__GetCameraParams_Event__request(
  const void * untyped_member)
{
  const astra_camera_msgs__srv__GetCameraParams_Request__Sequence * member =
    (const astra_camera_msgs__srv__GetCameraParams_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__request(
  const void * untyped_member, size_t index)
{
  const astra_camera_msgs__srv__GetCameraParams_Request__Sequence * member =
    (const astra_camera_msgs__srv__GetCameraParams_Request__Sequence *)(untyped_member);
...
void * astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__request(
  void * untyped_member, size_t index)
{
  astra_camera_msgs__srv__GetCameraParams_Request__Sequence * member =
    (astra_camera_msgs__srv__GetCameraParams_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__fetch_function__GetCameraParams_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const astra_camera_msgs__srv__GetCameraParams_Request * item =
    ((const astra_camera_msgs__srv__GetCameraParams_Request *)
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__request(untyped_member, index));
  astra_camera_msgs__srv__GetCameraParams_Request * value =
    (astra_camera_msgs__srv__GetCameraParams_Request *)(untyped_value);
  *value = *item;
}

void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__assign_function__GetCameraParams_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  astra_camera_msgs__srv__GetCameraParams_Request * item =
    ((astra_camera_msgs__srv__GetCameraParams_Request *)
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__request(untyped_member, index));
  const astra_camera_msgs__srv__GetCameraParams_Request * value =
    (const astra_camera_msgs__srv__GetCameraParams_Request *)(untyped_value);
  *item = *value;
}

bool astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__resize_function__GetCameraParams_Event__request(
  void * untyped_member, size_t size)
{
  astra_camera_msgs__srv__GetCameraParams_Request__Sequence * member =
    (astra_camera_msgs__srv__GetCameraParams_Request__Sequence *)(untyped_member);
  astra_camera_msgs__srv__GetCameraParams_Request__Sequence__fini(member);
  return astra_camera_msgs__srv__GetCameraParams_Request__Sequence__init(member, size);
}

size_t astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__size_function__GetCameraParams_Event__response(
  const void * untyped_member)
{
  const astra_camera_msgs__srv__GetCameraParams_Response__Sequence * member =
    (const astra_camera_msgs__srv__GetCameraParams_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__response(
  const void * untyped_member, size_t index)
{
  const astra_camera_msgs__srv__GetCameraParams_Response__Sequence * member =
    (const astra_camera_msgs__srv__GetCameraParams_Response__Sequence *)(untyped_member);
...
void * astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__response(
  void * untyped_member, size_t index)
{
  astra_camera_msgs__srv__GetCameraParams_Response__Sequence * member =
    (astra_camera_msgs__srv__GetCameraParams_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__fetch_function__GetCameraParams_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const astra_camera_msgs__srv__GetCameraParams_Response * item =
    ((const astra_camera_msgs__srv__GetCameraParams_Response *)
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__response(untyped_member, index));
  astra_camera_msgs__srv__GetCameraParams_Response * value =
    (astra_camera_msgs__srv__GetCameraParams_Response *)(untyped_value);
  *value = *item;
}

void astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__assign_function__GetCameraParams_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  astra_camera_msgs__srv__GetCameraParams_Response * item =
    ((astra_camera_msgs__srv__GetCameraParams_Response *)
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__response(untyped_member, index));
  const astra_camera_msgs__srv__GetCameraParams_Response * value =
    (const astra_camera_msgs__srv__GetCameraParams_Response *)(untyped_value);
  *item = *value;
}

bool astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__resize_function__GetCameraParams_Event__response(
  void * untyped_member, size_t size)
{
  astra_camera_msgs__srv__GetCameraParams_Response__Sequence * member =
    (astra_camera_msgs__srv__GetCameraParams_Response__Sequence *)(untyped_member);
  astra_camera_msgs__srv__GetCameraParams_Response__Sequence__fini(member);
  return astra_camera_msgs__srv__GetCameraParams_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(astra_camera_msgs__srv__GetCameraParams_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(astra_camera_msgs__srv__GetCameraParams_Event, request),  // bytes offset in struct
    NULL,  // default value
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__size_function__GetCameraParams_Event__request,  // size() function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__request,  // get_const(index) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__request,  // get(index) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__fetch_function__GetCameraParams_Event__request,  // fetch(index, &value) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__assign_function__GetCameraParams_Event__request,  // assign(index, value) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__resize_function__GetCameraParams_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(astra_camera_msgs__srv__GetCameraParams_Event, response),  // bytes offset in struct
    NULL,  // default value
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__size_function__GetCameraParams_Event__response,  // size() function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_const_function__GetCameraParams_Event__response,  // get_const(index) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__get_function__GetCameraParams_Event__response,  // get(index) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__fetch_function__GetCameraParams_Event__response,  // fetch(index, &value) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__assign_function__GetCameraParams_Event__response,  // assign(index, value) function pointer
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__resize_function__GetCameraParams_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_members = {
  "astra_camera_msgs__srv",  // message namespace
  "GetCameraParams_Event",  // message name
  3,  // number of fields
  sizeof(astra_camera_msgs__srv__GetCameraParams_Event),
  false,  // has_any_key_member_
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_member_array,  // message members
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_type_support_handle = {
  0,
  &astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_astra_camera_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Event)() {
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Request)();
  astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Response)();
  if (!astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_type_support_handle.typesupport_identifier) {
    astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t astra_camera_msgs__srv__detail__get_camera_params__rosidl_typesupport_introspection_c__GetCameraParams_service_type_support_handle = {
  ...
  &astra_camera_msgs__srv__GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_type_support_handle,
  &astra_camera_msgs__srv__GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_type_support_handle,
  &astra_camera_msgs__srv__GetCameraParams_Event__rosidl_typesupport_introspection_c__GetCameraParams_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_astra_camera_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Event)()->data;
  }
