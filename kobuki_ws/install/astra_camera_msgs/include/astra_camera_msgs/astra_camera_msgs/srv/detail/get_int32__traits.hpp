...
inline std::string to_yaml(const GetInt32_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use astra_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const astra_camera_msgs::srv::GetInt32_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  astra_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use astra_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const astra_camera_msgs::srv::GetInt32_Event & msg)
{
  return astra_camera_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<astra_camera_msgs::srv::GetInt32_Event>()
{
  return "astra_camera_msgs::srv::GetInt32_Event";
}

template<>
inline const char * name<astra_camera_msgs::srv::GetInt32_Event>()
{
  return "astra_camera_msgs/srv/GetInt32_Event";
}

template<>
struct has_fixed_size<astra_camera_msgs::srv::GetInt32_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<astra_camera_msgs::srv::GetInt32_Event>
  : std::integral_constant<bool, has_bounded_size<astra_camera_msgs::srv::GetInt32_Request>::value && has_bounded_size<astra_camera_msgs::srv::GetInt32_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<astra_camera_msgs::srv::GetInt32_Event>
  : std::true_type {};
