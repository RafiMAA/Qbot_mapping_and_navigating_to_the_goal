...
[[deprecated("use astra_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const astra_camera_msgs::srv::GetDeviceInfo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  astra_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use astra_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const astra_camera_msgs::srv::GetDeviceInfo_Event & msg)
{
  return astra_camera_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<astra_camera_msgs::srv::GetDeviceInfo_Event>()
{
  return "astra_camera_msgs::srv::GetDeviceInfo_Event";
}

template<>
inline const char * name<astra_camera_msgs::srv::GetDeviceInfo_Event>()
{
  return "astra_camera_msgs/srv/GetDeviceInfo_Event";
}

template<>
struct has_fixed_size<astra_camera_msgs::srv::GetDeviceInfo_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<astra_camera_msgs::srv::GetDeviceInfo_Event>
  : std::integral_constant<bool, has_bounded_size<astra_camera_msgs::srv::GetDeviceInfo_Request>::value && has_bounded_size<astra_camera_msgs::srv::GetDeviceInfo_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<astra_camera_msgs::srv::GetDeviceInfo_Event>
  : std::true_type {};
