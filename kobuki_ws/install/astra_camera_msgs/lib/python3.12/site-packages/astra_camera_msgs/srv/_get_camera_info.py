...
class Metaclass_GetCameraInfo_Event(type):
    """Metaclass of message 'GetCameraInfo_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_camera_info__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_camera_info__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_camera_info__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_camera_info__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_camera_info__event
...
class GetCameraInfo_Event(metaclass=Metaclass_GetCameraInfo_Event):
    """Message class 'GetCameraInfo_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<astra_camera_msgs/GetCameraInfo_Request, 1>',
        'response': 'sequence<astra_camera_msgs/GetCameraInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetCameraInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetCameraInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetCameraInfo_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetCameraInfo_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetCameraInfo_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetCameraInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetCameraInfo_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetCameraInfo_Response'"
...
class Metaclass_GetCameraInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_camera_info.Metaclass_GetCameraInfo_Event._TYPE_SUPPORT is None:
                _get_camera_info.Metaclass_GetCameraInfo_Event.__import_type_support__()
...
class GetCameraInfo(metaclass=Metaclass_GetCameraInfo):
    ...
    from astra_camera_msgs.srv._get_camera_info import GetCameraInfo_Event as Event
