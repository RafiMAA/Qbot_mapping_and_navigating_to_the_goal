...
class Metaclass_GetDeviceInfo_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from astra_camera_msgs.msg import DeviceInfo
...
class GetDeviceInfo_Response(metaclass=Metaclass_GetDeviceInfo_Response):
    ...
    _fields_and_field_types = {
        'info': 'astra_camera_msgs/DeviceInfo',
        'success': 'boolean',
        'message': 'string',
    }
    ...
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'msg'], 'DeviceInfo'),  # noqa: E501
...
class GetDeviceInfo_Event(metaclass=Metaclass_GetDeviceInfo_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<astra_camera_msgs/GetDeviceInfo_Request, 1>',
        'response': 'sequence<astra_camera_msgs/GetDeviceInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetDeviceInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetDeviceInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetDeviceInfo_Request
    ...
    def response(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetDeviceInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetDeviceInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'astra_camera_msgs.srv.GetDeviceInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from astra_camera_msgs.srv import _get_device_info
...
class GetDeviceInfo(metaclass=Metaclass_GetDeviceInfo):
    from astra_camera_msgs.srv._get_device_info import GetDeviceInfo_Request as Request
    from astra_camera_msgs.srv._get_device_info import GetDeviceInfo_Response as Response
    from astra_camera_msgs.srv._get_device_info import GetDeviceInfo_Event as Event
