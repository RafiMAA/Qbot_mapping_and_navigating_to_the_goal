    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces.action.Navigation_Goal')
            logger.debug(
...
class Navigation_Goal(metaclass=Metaclass_Navigation_Goal):
    ...
    _fields_and_field_types = {
        'end_position': 'interfaces/Position',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['interfaces', 'msg'], 'Position'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from interfaces.msg import Position
        self.end_position = kwargs.get('end_position', Position())
    ...
    def end_position(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'end_position' field must be a sub message of type 'Position'"
...
class Metaclass_Navigation_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_SendGoal_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation_SendGoal_Request(metaclass=Metaclass_Navigation_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'interfaces/Navigation_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from interfaces.action._navigation import Navigation_Goal
...
class Metaclass_Navigation_SendGoal_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_SendGoal_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_SendGoal_Event(type):
    """Metaclass of message 'Navigation_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_SendGoal_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__navigation__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__navigation__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__navigation__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__navigation__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__navigation__send_goal__event
...
class Navigation_SendGoal_Event(metaclass=Metaclass_Navigation_SendGoal_Event):
    """Message class 'Navigation_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interfaces/Navigation_SendGoal_Request, 1>',
        'response': 'sequence<interfaces/Navigation_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces.action import Navigation_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Navigation_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Navigation_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces.action import Navigation_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Navigation_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Navigation_SendGoal_Response'"
...
class Metaclass_Navigation_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from interfaces.action import _navigation
            ...
            if _navigation.Metaclass_Navigation_SendGoal_Event._TYPE_SUPPORT is None:
                _navigation.Metaclass_Navigation_SendGoal_Event.__import_type_support__()


class Navigation_SendGoal(metaclass=Metaclass_Navigation_SendGoal):
    from interfaces.action._navigation import Navigation_SendGoal_Request as Request
    from interfaces.action._navigation import Navigation_SendGoal_Response as Response
    from interfaces.action._navigation import Navigation_SendGoal_Event as Event
...
class Metaclass_Navigation_GetResult_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_GetResult_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_GetResult_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_GetResult_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation_GetResult_Response(metaclass=Metaclass_Navigation_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'interfaces/Navigation_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from interfaces.action._navigation import Navigation_Result
...
class Metaclass_Navigation_GetResult_Event(type):
    """Metaclass of message 'Navigation_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_GetResult_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__navigation__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__navigation__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__navigation__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__navigation__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__navigation__get_result__event
...
class Navigation_GetResult_Event(metaclass=Metaclass_Navigation_GetResult_Event):
    """Message class 'Navigation_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<interfaces/Navigation_GetResult_Request, 1>',
        'response': 'sequence<interfaces/Navigation_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces.action import Navigation_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Navigation_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Navigation_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces.action import Navigation_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Navigation_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Navigation_GetResult_Response'"
        self._response = value
...
class Metaclass_Navigation_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _navigation.Metaclass_Navigation_GetResult_Event._TYPE_SUPPORT is None:
                _navigation.Metaclass_Navigation_GetResult_Event.__import_type_support__()


class Navigation_GetResult(metaclass=Metaclass_Navigation_GetResult):
    from interfaces.action._navigation import Navigation_GetResult_Request as Request
    from interfaces.action._navigation import Navigation_GetResult_Response as Response
    from interfaces.action._navigation import Navigation_GetResult_Event as Event
...
class Metaclass_Navigation_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.action.Navigation_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation_FeedbackMessage(metaclass=Metaclass_Navigation_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'interfaces/Navigation_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces', 'action'], 'Navigation_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from interfaces.action._navigation import Navigation_Feedback
...
class Navigation(metaclass=Metaclass_Navigation):
    ...
    from interfaces.action._navigation import Navigation_Goal as Goal
    # The result message defined in the action definition.
    from interfaces.action._navigation import Navigation_Result as Result
    # The feedback message defined in the action definition.
    from interfaces.action._navigation import Navigation_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from interfaces.action._navigation import Navigation_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from interfaces.action._navigation import Navigation_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from interfaces.action._navigation import Navigation_FeedbackMessage as FeedbackMessage
