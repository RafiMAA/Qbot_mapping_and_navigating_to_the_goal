...
: ${AMENT_CURRENT_PREFIX:="/home/abdulrafi/Desktop/ROS2_Final_Project/kobuki_ws/install/kobuki_random_walker"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kobuki_random_walker/environment/library_path.sh"
