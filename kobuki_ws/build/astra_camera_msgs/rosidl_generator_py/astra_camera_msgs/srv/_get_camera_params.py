...
class Metaclass_GetCameraParams_Event(type):
    """Metaclass of message 'GetCameraParams_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_camera_params__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_camera_params__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_camera_params__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_camera_params__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_camera_params__event
...
class GetCameraParams_Event(metaclass=Metaclass_GetCameraParams_Event):
    """Message class 'GetCameraParams_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<astra_camera_msgs/GetCameraParams_Request, 1>',
        'response': 'sequence<astra_camera_msgs/GetCameraParams_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetCameraParams_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['astra_camera_msgs', 'srv'], 'GetCameraParams_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetCameraParams_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetCameraParams_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetCameraParams_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from astra_camera_msgs.srv import GetCameraParams_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetCameraParams_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetCameraParams_Response'"
...
class Metaclass_GetCameraParams(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_camera_params.Metaclass_GetCameraParams_Event._TYPE_SUPPORT is None:
                _get_camera_params.Metaclass_GetCameraParams_Event.__import_type_support__()
...
class GetCameraParams(metaclass=Metaclass_GetCameraParams):
    ...
    from astra_camera_msgs.srv._get_camera_params import GetCameraParams_Event as Event
