...
static const _GetCameraParams_Event_type_support_symbol_names_t _GetCameraParams_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, astra_camera_msgs, srv, GetCameraParams_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, astra_camera_msgs, srv, GetCameraParams_Event)),
  }
};
...
{
  return &::astra_camera_msgs::srv::rosidl_typesupport_cpp::GetCameraParams_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, astra_camera_msgs, srv, GetCameraParams_Event)() {
  return get_message_type_support_handle<astra_camera_msgs::srv::GetCameraParams_Event>();
}
...
static const rosidl_service_type_support_t GetCameraParams_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<astra_camera_msgs::srv::GetCameraParams_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<astra_camera_msgs::srv::GetCameraParams_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<astra_camera_msgs::srv::GetCameraParams_Event>(),
