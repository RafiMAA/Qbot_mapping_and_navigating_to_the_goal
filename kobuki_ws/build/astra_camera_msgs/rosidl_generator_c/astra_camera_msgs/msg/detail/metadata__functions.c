...
astra_camera_msgs__msg__Metadata__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  astra_camera_msgs__msg__Metadata * msg = (astra_camera_msgs__msg__Metadata *)allocator.allocate(sizeof(astra_camera_msgs__msg__Metadata), allocator.state);
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__msg__Metadata__Sequence__init(astra_camera_msgs__msg__Metadata__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__msg__Metadata *)allocator.zero_allocate(size, sizeof(astra_camera_msgs__msg__Metadata), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  astra_camera_msgs__msg__Metadata__Sequence * array = (astra_camera_msgs__msg__Metadata__Sequence *)allocator.allocate(sizeof(astra_camera_msgs__msg__Metadata__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  astra_camera_msgs__msg__Metadata__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    astra_camera_msgs__msg__Metadata * data =
      (astra_camera_msgs__msg__Metadata *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!astra_camera_msgs__msg__Metadata__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          astra_camera_msgs__msg__Metadata__fini(&output->data[i]);
        }
        return false;
      }
    }
