...
// IWYU pragma: private, include "astra_camera_msgs/srv/get_device_info.hpp"
...
#ifndef _WIN32
# define DEPRECATED__astra_camera_msgs__srv__GetDeviceInfo_Event __attribute__((deprecated))
#else
# define DEPRECATED__astra_camera_msgs__srv__GetDeviceInfo_Event __declspec(deprecated)
#endif
...
struct GetDeviceInfo_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<astra_camera_msgs::srv::GetDeviceInfo_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<astra_camera_msgs::srv::GetDeviceInfo_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<astra_camera_msgs::srv::GetDeviceInfo_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<astra_camera_msgs::srv::GetDeviceInfo_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<astra_camera_msgs::srv::GetDeviceInfo_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<astra_camera_msgs::srv::GetDeviceInfo_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<astra_camera_msgs::srv::GetDeviceInfo_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<astra_camera_msgs::srv::GetDeviceInfo_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__astra_camera_msgs__srv__GetDeviceInfo_Event
    std::shared_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__astra_camera_msgs__srv__GetDeviceInfo_Event
    std::shared_ptr<astra_camera_msgs::srv::GetDeviceInfo_Event_<ContainerAllocator> const>
...
using GetDeviceInfo_Event =
  astra_camera_msgs::srv::GetDeviceInfo_Event_<std::allocator<void>>;
...
struct GetDeviceInfo
{
  ...
  using Event = astra_camera_msgs::srv::GetDeviceInfo_Event;
};
