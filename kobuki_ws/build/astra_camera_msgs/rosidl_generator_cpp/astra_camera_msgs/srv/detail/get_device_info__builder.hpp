...
{
public:
  explicit Init_GetDeviceInfo_Event_response(::astra_camera_msgs::srv::GetDeviceInfo_Event & msg)
  : msg_(msg)
  {}
  ::astra_camera_msgs::srv::GetDeviceInfo_Event response(::astra_camera_msgs::srv::GetDeviceInfo_Event::_response_type arg)
  {
...
private:
  ::astra_camera_msgs::srv::GetDeviceInfo_Event msg_;
};

class Init_GetDeviceInfo_Event_request
{
public:
  explicit Init_GetDeviceInfo_Event_request(::astra_camera_msgs::srv::GetDeviceInfo_Event & msg)
  : msg_(msg)
  {}
  Init_GetDeviceInfo_Event_response request(::astra_camera_msgs::srv::GetDeviceInfo_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetDeviceInfo_Event_request info(::astra_camera_msgs::srv::GetDeviceInfo_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::astra_camera_msgs::srv::GetDeviceInfo_Event>()
{
  return astra_camera_msgs::srv::builder::Init_GetDeviceInfo_Event_info();
}
