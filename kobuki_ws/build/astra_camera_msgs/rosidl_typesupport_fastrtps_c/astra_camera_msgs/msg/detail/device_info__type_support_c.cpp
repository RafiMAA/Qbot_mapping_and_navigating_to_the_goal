...
#include "astra_camera_msgs/msg/detail/device_info__rosidl_typesupport_fastrtps_c.h"
...
using _DeviceInfo__ros_msg_type = astra_camera_msgs__msg__DeviceInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->supported_min_sdk_version;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  astra_camera_msgs__msg__DeviceInfo * ros_message)
{
  ...
  // Field name: supported_min_sdk_version
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->supported_min_sdk_version.data) {
      rosidl_runtime_c__String__init(&ros_message->supported_min_sdk_version);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->supported_min_sdk_version,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'supported_min_sdk_version'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astra_camera_msgs__msg__DeviceInfo;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const astra_camera_msgs__msg__DeviceInfo * ros_message = static_cast<const astra_camera_msgs__msg__DeviceInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_astra_camera_msgs__msg__DeviceInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  astra_camera_msgs__msg__DeviceInfo * ros_message = static_cast<astra_camera_msgs__msg__DeviceInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_astra_camera_msgs__msg__DeviceInfo(cdr, ros_message);
}
...
static size_t _DeviceInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_astra_camera_msgs__msg__DeviceInfo(
