...
#include "astra_camera_msgs/msg/detail/metadata__rosidl_typesupport_fastrtps_c.h"
...
using _Metadata__ros_msg_type = astra_camera_msgs__msg__Metadata;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_camera_msgs
bool cdr_serialize_astra_camera_msgs__msg__Metadata(
  const astra_camera_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_camera_msgs
bool cdr_deserialize_astra_camera_msgs__msg__Metadata(
  eprosima::fastcdr::Cdr & cdr,
  astra_camera_msgs__msg__Metadata * ros_message)
{
  // Field name: header
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = astra_camera_msgs__msg__Metadata;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_camera_msgs
bool cdr_serialize_key_astra_camera_msgs__msg__Metadata(
  const astra_camera_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_camera_msgs
size_t get_serialized_size_key_astra_camera_msgs__msg__Metadata(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Metadata__ros_msg_type * ros_message = static_cast<const _Metadata__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_camera_msgs
size_t max_serialized_size_key_astra_camera_msgs__msg__Metadata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const astra_camera_msgs__msg__Metadata * ros_message = static_cast<const astra_camera_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_astra_camera_msgs__msg__Metadata(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  astra_camera_msgs__msg__Metadata * ros_message = static_cast<astra_camera_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_astra_camera_msgs__msg__Metadata(cdr, ros_message);
}
...
static size_t _Metadata__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_astra_camera_msgs__msg__Metadata(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, astra_camera_msgs, msg, Metadata)() {
