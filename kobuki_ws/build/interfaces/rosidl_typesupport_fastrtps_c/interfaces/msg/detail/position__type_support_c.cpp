...
#include "interfaces/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
using _Position__ros_msg_type = interfaces__msg__Position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Position;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__Position * ros_message = static_cast<const interfaces__msg__Position *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__Position(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__Position * ros_message = static_cast<interfaces__msg__Position *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__Position(cdr, ros_message);
}

static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Position(
...
static size_t _Position__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Position(
